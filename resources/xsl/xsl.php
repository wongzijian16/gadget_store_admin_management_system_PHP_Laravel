...
namespace {
	...
	class XSLTProcessor {
		...
		/**
		 * Import stylesheet
		 * <p>This method imports the stylesheet into the <code>XSLTProcessor</code> for transformations.</p>
		 * @param object $stylesheet <p>The imported style sheet as a <code>DOMDocument</code> or <code>SimpleXMLElement</code> object.</p>
		 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
		 ...
		 * <p>Sets the value of one or more parameters to be used in subsequent transformations with <code>XSLTProcessor</code>. If the parameter doesn't exist in the stylesheet it will be ignored.</p>
		 * @param string $namespace <p>The namespace URI of the XSLT parameter.</p>
		 * @param string $name <p>The local name of the XSLT parameter.</p>
		 ...
		 * <p>Transforms the source node to a <code>DOMDocument</code> applying the stylesheet given by the <code>XSLTProcessor::importStylesheet()</code> method.</p>
		 * @param object $document <p>The node to be transformed.</p>
		 * @param ?string $returnClass
		 * @return DOMDocument|false <p>The resulting <code>DOMDocument</code> or <b><code>false</code></b> on error.</p>
		 ...
		 * @return string|null|false <p>The result of the transformation as a string or <b><code>false</code></b> on error.</p>
